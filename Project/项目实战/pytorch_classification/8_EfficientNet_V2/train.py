...
def main(args):
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        val_loss, val_acc = evaluate(
            model=model, data_loader=validate_loader, device=device, epoch=epoch
        )
...
if __name__ == "__main__":
    ...
    # 链接：https://pan.baidu.com/s/19hWNri5eOGI4Sfil29jn3A 提取码：cpdd
    parser.add_argument(
        "--weights",
        type=str,
        default="./pre_efficientnetv2-s.pth",
