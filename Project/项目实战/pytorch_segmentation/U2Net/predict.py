...
def main():
    weights_path = "./model_full.pth"
    img_path = "./test_images/dog1.webp"
    threshold = 0.5
    ...
    origin_img = cv2.cvtColor(
        cv2.imread(img_path, flags=cv2.IMREAD_COLOR), cv2.COLOR_BGR2RGB
    )
