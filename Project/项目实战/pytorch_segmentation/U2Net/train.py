...
def main(args):
    ...
    optimizer = torch.optim.AdamW(
        params_group, lr=args.lr, weight_decay=args.weight_decay
    )
    lr_scheduler = create_lr_scheduler(
        optimizer, len(train_data_loader), args.epochs, warmup=True, warmup_epochs=2
    )
...
def parse_args():
    ...
    parser.add_argument("--data-path", default="./data_set", help="DUTS root")
